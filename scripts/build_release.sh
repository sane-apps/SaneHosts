...
echo "2. Upload DMG to Cloudflare R2:"
echo "   npx wrangler r2 object put sanebar-downloads/${DMG_NAME} \\"
echo "     --file=$OUTPUT_DIR/$DMG_NAME --content-type=application/octet-stream --remote"
echo "3. Deploy website + appcast to Cloudflare Pages:"
