...
The app may send a few simple anonymous product events, such as app launches, onboarding progress, checkout/license events, trial or paid-access status, app version, build, OS version, platform, and distribution channel. Those events do not include your hosts entries, profile contents, personal files, device identifiers, or account identifiers.
...
- It sends a few simple anonymous product events, such as trial launches and license activation
...
- **Lemon Squeezy** to process purchases and license delivery
